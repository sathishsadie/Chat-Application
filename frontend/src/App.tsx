  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100 font-sans">
      <header className="bg-green-600 text-white p-4 text-center shadow-md">
        <h1 className="text-2xl font-bold">Kitchen Management AI 🧑‍🌾</h1>
      </header>
          ...
          {messages.length === 0 && (
            <div className="text-center p-6 bg-white rounded-lg shadow-sm">
              <p className="text-gray-600">
                    Welcome to Kitchen AI! Ask me to check ingredients, buy missing items, or guide you to cook Curd Rice, Lemon Rice, or Tomato Rice.
              </p>
            </div>
          )}
